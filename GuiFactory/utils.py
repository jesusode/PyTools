...
class ScrollableListbox(tkinter.Frame):
    '''
    Clase de utilidad que implementa un Listbox con barra de scroll.
    Se puede obtener el Listbox con instance.listbox.
    '''
    def __init__(self,parent,*args,**kwargs):
        #super().__init__(self,parent)
        tkinter.Frame.__init__(self,parent)
        self.listbox = tkinter.Listbox(self,**kwargs)
        self.listbox.insert("end",*args)
        self._scroll = tkinter.Scrollbar(self,command = self.listbox.yview)
        self.listbox.configure(yscrollcommand=self._scroll.set)
