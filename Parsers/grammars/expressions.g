...
import io
        ...
        boolexp params {{ a=0,b=1,c=2}} returns {{boolexp_values}} :  orexp (AND orexp)*;
        orexp : notexp (OR notexp {{print("Code repetitivo")}})* {{print("Code final de group")}};
        notexp : | (NOT cmpexp {{print("not cmp")}}) | (LPAREN boolexp RPAREN) |cmpexp {{print("yendo por cmpexp()")}};
